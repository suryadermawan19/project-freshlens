...
// --- WIDGET BARU: FreshnessStatusBar yang sudah didesain ulang ---
class FreshnessStatusBar extends StatelessWidget {
  ...
  const FreshnessStatusBar({
    ...
    this.maxShelfLife = 10, // Asumsi masa simpan maks untuk kalkulasi bar
  });

  @override
  Widget build(BuildContext context) {
    // Tentukan warna dan teks status berdasarkan sisa hari
  ...
  Widget _buildBatchCard(BuildContext context, Batch batch, bool isPriority) {
    return Slidable(
      endActionPane: ActionPane(
        ...
        children: [
          SlidableAction(
            onPressed: (context) => _showUsedConfirmation(batch),
